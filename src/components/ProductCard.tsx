...
export const ProductCard: React.FC<ProductCardProps> = ({ product, onClick }) => {
  return (
    <div
      ...
      className="bg-gradient-to-br from-white to-green-50/30 rounded-xl shadow-md border border-green-200 overflow-hidden cursor-pointer group hover:shadow-xl hover:shadow-green-200/50 transition-all duration-300 hover:-translate-y-2 hover:border-emerald-300"
    >
